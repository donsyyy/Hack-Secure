...
passwd = getpass.getpass("Enter the password (it would be invisible): ") # i added this library to make the password invisible when typing it, just like on linux command line
