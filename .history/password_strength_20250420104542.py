...
def strength(passwd):
    ...
    count = intersection(passwd, lowercase_letters) and intersection(passwd, uppercase_letters) and \
    and intersection(passwd, numbers) and intersection(passwd, special_characters) and len(L) >= 12
