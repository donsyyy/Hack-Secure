...
# In this print function, the password shouldn't be shown at all because the point of all this is for it to be hidden, but I added it just to understand how the code works
